...
import { AgentAbortController, isAbortError } from './abort-controller';
// ============================================================================
// Agent 类
// ============================================================================
export class Agent {
    ...
    async handleAgentMode(message, startTime) {
        ...
        const result = await this.abortController.wrapWithAbort(this.runner.execute(initialState));
    ...
    setHistory(history) { this.conversationHistory = [...history]; }
    // ========================================================================
    // Abort/Resume API
    // ========================================================================
    /**
